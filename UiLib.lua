-- Project Berpa UI Library
-- Clean source; the main script is protected by Junkie.
...
local UILIB_GLOBAL = "ProjectBerpaUILib"
...
local function uniqueGuiName()
	return "PB_" .. HttpService:GenerateGUID(false):gsub("-", ""):sub(1, 16)
end
